        ...
        <section className="relative h-screen w-full overflow-hidden bg-black flex items-center justify-center">
            ...
            <div className="relative z-10 max-w-5xl mx-auto px-6 text-center space-y-8">
                ...
                >
                    ...
                    <p className="text-xl md:text-2xl text-slate-200 max-w-3xl mx-auto leading-relaxed drop-shadow-lg font-light">
                        The central nervous system for potential modern enterprises.
                        <span className="block mt-2 text-slate-300">Integrating Clinical AI, Operations, and Finance into one Sentinel.</span>
                    </p>

                    <div className="flex flex-col sm:flex-row gap-6 justify-center pt-8">
                        <button className="group relative px-10 py-5 bg-phrelis-blue text-phrelis-charcoal font-bold text-lg rounded-xl overflow-hidden transition-all hover:scale-105 hover:shadow-[0_0_30px_rgba(0,242,255,0.5)]">
                        ...
                        <button className="group px-10 py-5 rounded-xl border border-white/20 bg-white/5 text-white font-medium text-lg hover:bg-white/10 hover:border-white/40 transition-all backdrop-blur-md">
                            View Architecture
                        </button>
                    </div>
                </motion.div>
